...
export default function RecipesPage() {
  ...
  const filteredRecipes = recipes.filter(recipe =>
    ...
    recipe.time.toLowerCase().includes(searchTerm.toLowerCase()) || // Example: search by time
    recipe.price.toLowerCase().includes(searchTerm.toLowerCase()) // Example: search by price
